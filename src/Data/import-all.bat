...
set FILES=skills.ndjson profile.ndjson education.ndjson experience.ndjson projects.ndjson achievements.ndjson certifications.ndjson testimonials.ndjson navigation.ndjson siteSettings.ndjson 
